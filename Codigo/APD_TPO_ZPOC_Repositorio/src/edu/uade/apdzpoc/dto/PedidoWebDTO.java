...
public class PedidoWebDTO implements Serializable {
	...
	public String toString() {
		return "PedidoWebDTO [idPedido=" + idPedido + ", cliente=" + cliente + ", fechaGeneracion=" + fechaGeneracion
	...
	public String toJSONString() {
		return "{ \"idPedido\": " + idPedido + ",  \"cliente\": " + "{ \"idCliente\":" + cliente.getIdCliente()
				+ ", \"documento\": " + cliente.getDocumento() + ", \"nombre\": \"" + cliente.getNombre()
				+ "\" }, \"fechaGeneracion\": \"" + String.valueOf(this.fechaGeneracion) + "\", \"fechaDespacho\": " + String.valueOf(this.fechaDespacho)
				+ ", \"fechaEntrega\": " + String.valueOf(this.fechaDeEntrega) + ", \"estadoPedido\": \"" + estadoPedido
				+ "\", \"direccionPedido\": \"" + this.direccionPedido + "\"}";
	}
