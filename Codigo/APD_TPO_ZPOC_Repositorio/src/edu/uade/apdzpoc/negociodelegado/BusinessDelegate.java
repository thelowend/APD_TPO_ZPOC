...
public class BusinessDelegate {
	...
	public int crearPedidoWeb(List<ItemPedidoDTO> articulosComprados, ClienteDTO cliente, String direccion)
			throws ComunicationException, ArticuloException, ArticuloProveedorException, ProveedorException,
			ClienteException {
		try {
	...
	public void procesarPedido(PedidoWebDTO pw) throws ComunicationException, ArticuloException,
			ArticuloProveedorException, ProveedorException, PedidoWebException {
		try {
	...
	public void despacharPedido(PedidoWebDTO pw, Date fechaEntrega, String empresaTransporte)
			throws ComunicationException, PedidoWebException {
		try {
	...
	public void validarIngresoOrdenCompra(OrdenCompraDTO oc, EstadoOC estadoOC, LoteDTO lote)
			throws ComunicationException, LoteException, UbicacionException, ArticuloException,
			ArticuloProveedorException, ProveedorException, OrdenCompraException {
		try {
	...
	public void ajustarInventario(int cantidad, CausaAjuste causa, int legajoOperador, int legajoAutorizante,
			LoteDTO lote, DestinoArticulos destino) throws ComunicationException, ArticuloException, LoteException {
		try {
	...
	public PedidoWebDTO obtenerPedidoWebParaPublicar(int idPedido)
			throws RemoteException, ComunicationException, PedidoWebException {
		try {
	...
	public OrdenCompraDTO obtenerOrdenCompraParaPublicar(int idOC)
			throws RemoteException, ComunicationException, OrdenCompraException {
		try {
	...
	public ArticuloStockDTO obtenerDetalleStockdeArticulo(int codigoBarra)
			throws RemoteException, ComunicationException, ArticuloException {
		try {
